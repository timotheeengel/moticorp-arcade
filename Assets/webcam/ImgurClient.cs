...
public class ImgurClient
{
    ...
    private const string _albumDelethashFileLocation = "C:/images/deletehash.txt";
    private const string _albumIdFileLocation = "C:/images/id.txt";
    private const string _baseAlbumCreationUrl = "https://api.imgur.com/3/album";
    ...
    {
        if (!File.Exists(_albumDelethashFileLocation))
            CreateAlbum();
        ...
        Thread t = new Thread(() =>
        {
            using (WebClient client = new WebClient())
            {
                ...
                {
                    { "image", base64Image },
                    { "album" , File.ReadAllText(_albumDelethashFileLocation) }
                };
